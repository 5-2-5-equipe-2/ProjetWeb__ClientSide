...
export default class Game extends React.Component {
  ...
  __setTimer() {
    this.timer = setInterval(() => this.__draw(), 10 / this.options.fps);
  }
  ...
  render() {
    return <canvas id="canvas" ref={ref => this.canvas = ref} height={160} width={340}></canvas>;
  }
};